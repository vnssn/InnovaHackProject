...
import { useDashboardAnalytics, useCategoryBreakdown } from '@/hooks/useAnalytics';
...
export default function DashboardPage() {
  ...
  // Loading state placeholder (could be replaced with a proper skeleton loader)
  if (isDashboardLoading || isCategoryLoading || isInsightsLoading) {
      ...
      <div className="flex flex-col w-full gap-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-md w-full mt-sm">
          ...
          <div className="lg:col-span-2 bg-surface-container rounded-xl p-md shadow-sm flex flex-col relative">
            ...
            {/* Chart omitted for brevity - could be implemented with dynamic data mapping */}
            <div className="w-full h-[300px] mt-auto relative flex items-center justify-center border border-dashed border-outline-variant rounded">
              <span className="text-on-surface-variant">Chart Data Here</span>
            </div>
          </div>
